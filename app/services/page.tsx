  ...
  const services = [
    {
      ...
      description: "Custom mobile and desktop applications built for performance, scalability, and user experience.",
      icon: "/icons/app-dev.png",
    },
    {
      id: 2,
      title: "Web Development",
      description: "Responsive, fast-loading websites and web apps tailored to your brand and users.",
      icon: "/icons/web-dev.png",
    },
    {
      id: 3,
      title: "Artificial Intelligence",
      description: "Intelligent systems that automate, predict, and enhance business processes using AI.",
      icon: "/icons/ai.png",
    },
    {
      id: 4,
      title: "Research & Prototyping",
      description: "In-depth technical research and MVP development for startups and enterprises.",
      icon: "/icons/research.png",
    },
    {
      id: 5,
      title: "Machine Learning",
      description: "ML models that learn from your data to forecast trends, personalize experiences, and more.",
      icon: "/icons/ml.jpg",
    },
    {
      id: 6,
      title: "IT Consulting",
      description: "Expert guidance and solutions tailored to your digital transformation goals.",
    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans px-4 py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto px-4">
        {services.map((service) => (
          <motion.div
            key={service.id}
            className="bg-gray-50 rounded-xl p-8 shadow-sm hover:shadow-md transition-all border border-gray-100"
