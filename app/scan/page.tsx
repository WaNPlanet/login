...
/>
        ...
        <div className="bg-base-100  rounded-lg p-6 flex flex-col justify-center h-[500px]">
          ...
          <div className="mt-4">
            <button onClick={startCamera} className="btn btn-success w-full lg:w-auto">Scan</button>
          </div>
        </div>
      </div>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60">
          <div className="bg-white p-4 rounded-lg shadow-lg w-full max-w-md">
            ...
            <div className="flex justify-between mt-4">
              <button onClick={captureImage} className="btn btn-success w-1/2">Capture</button>
              <button onClick={stopCamera} className="btn btn-danger w-1/2">Close</button>
            </div>
          </div>
        </div>
      )}
